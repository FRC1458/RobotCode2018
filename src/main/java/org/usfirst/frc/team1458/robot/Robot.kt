...
class Robot : BaseRobot() {
    ...
    */
    ...
    override fun robotSetup() {
        ...
        //talonRight.PIDconstants = PIDConstants(0.15, kI = 0.001, kD = 0.01, kF = 1.0/6.8777)
        //talonLeft.PIDconstants = PIDConstants(0.0, kF = 1.0/6.5305)
        //talonRight.PIDconstants = PIDConstants(0.0, kF = 1.0/6.8777)
    }
